        ...
        >
          ...
          <motion.div variants={itemVariants} className="space-y-6">
            ...
            <div className="flex space-x-3">
              {contactSettings.facebookEnabled && contactSettings.facebook && (
                <motion.a 
              ...
              {contactSettings.instagramEnabled && contactSettings.instagram && (
                <motion.a 
                  whileHover={{ scale: 1.1 }}
                  whileTap={{ scale: 0.9 }}
              ...
              {contactSettings.linkedinEnabled && contactSettings.linkedin && (
                <motion.a 
                  whileHover={{ scale: 1.1 }}
                  whileTap={{ scale: 0.9 }}
              ...
              {contactSettings.twitterEnabled && contactSettings.twitter && (
                <motion.a 
                  whileHover={{ scale: 1.1 }}
                  whileTap={{ scale: 0.9 }}
              ...
              {contactSettings.youtubeEnabled && contactSettings.youtube && (
                <motion.a 
                  whileHover={{ scale: 1.1 }}
                  whileTap={{ scale: 0.9 }}
