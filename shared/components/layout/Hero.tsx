...
export default function Hero() {
  ...
  return (
    <section className="relative min-h-[calc(100vh-80px)] flex items-center overflow-x-hidden bg-linear-to-br from-primary-50/40 via-white to-primary-50/30 dark:from-gray-900 dark:via-gray-900 dark:to-gray-800 lg:bg-none dark:lg:bg-linear-to-br dark:lg:from-gray-900 dark:lg:to-gray-800 transition-colors duration-200">
