        ...
        <div>
          ...
          <div className="space-y-4">
            ...
            <div className="grid grid-cols-2 gap-4">
              <div>
                <label htmlFor="pricing-min-price" className="block text-sm font-medium text-gray-700 mb-2">Prix minimum (filtre)</label>
                <input
              ...
              <div>
                <label htmlFor="pricing-max-price" className="block text-sm font-medium text-gray-700 mb-2">Prix maximum (filtre)</label>
                <input
            ...
            <div>
              <label htmlFor="pricing-price-step" className="block text-sm font-medium text-gray-700 mb-2">Pas de prix (filtre)</label>
              <input
                id="pricing-price-step"
                type="number"
                min="100"
                step="100"
