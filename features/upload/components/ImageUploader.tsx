      ...
      >
        {isUploading ? (
          ...
          <div className="flex flex-col items-center justify-center text-center">
            ...
            <p className="text-lg font-medium text-gray-900 mb-1">Cliquez pour uploader</p>
            <p className="text-sm text-gray-500 max-w-xs">{label.replace('Cliquez ou déposez votre image ici pour l\'uploader instantanément', 'Supporte JPG, PNG, WEBP')}</p>
          </div>
        )}
      </div>
