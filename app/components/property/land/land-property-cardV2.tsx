  ...
  return (
    ...
    >
      ...
      <CardContent className="py-2 pr-4 pl-0">
        {" "}
        {/* Update 1: Changed py-4 to py-2 */}
        <h3 className="text-xl font-bold text-primary mb-1 ml-0">
          {price}
        </h3>{" "}
        {/* Update 2: Changed mb-2 to mb-1 */}
        <p className="text-muted-foreground flex items-center mb-2 text-sm ml-0">
          {" "}
          {/* Update 2: Changed mb-3 to mb-2 */}
          <MapPin className="h-4 w-4 mr-1 flex-shrink-0" />
          <span className="truncate">{address}</span>
        </p>
        <div className="grid grid-cols-2 gap-x-2 gap-y-1 text-sm text-muted-foreground ml-0">
          {" "}
          {/* Update 2: Changed gap-y-2 to gap-y-1 */}
